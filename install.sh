...
# Fancy header
echo ""
echo -e "${BOLD}Quantic Spark Agent Installer${NC}"
echo ""
...
# Success message
echo ""
echo -e "${BOLD}${GREEN}✨ Quantic Spark Agent Installed! ${NC}"
echo ""
echo ""
...
if [[ ":${PATH}:" == *":${HOME}/.local/bin:"* ]]; then
  ...
  echo -e "${BOLD}Start using Quantic Spark Agent:${NC}"
  ...
  echo -e "${BOLD}2.${NC} Start using Quantic Spark Agent:"
  echo -e "   ${BOLD}qs-agent${NC}   ${DIM}(or: agent / cursor-agent)${NC}"
fi
